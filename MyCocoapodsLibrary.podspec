...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Brandon/MyCocoapodsLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Brandon' => 'brandon.se2009@gmail.com' }
  s.source           = { :git => 'https://github.com/BrandonSRT/MyCocoapodsLibrary.git', :tag => s.version.to_s }
